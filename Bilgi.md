...
<p align="center">
  <a href="https://www.ahmetxaltun.com/haber" target="_blank" target="_blank">
    <img src="https://i.hizliresim.com/lbyue4r.png" alt="drawing board" width="100%" />
  </a>
</p>
...
- Yüksek performans
- Haber resmi, başlığı ve kısa açıklaması ile önizleme
- Haber kaynağının gösterilmesi
- Haber kaç dakika önce paylaşıldığı bilgisi
- Gün vaktine göre kısa karşılama
- Anlık saat ve gün bilgisi
...
Proje kodlarını ve nasıl çalıştığını aşağıdaki linkten inceleyebilirsiniz.

```bash
https://www.ahmetxaltun.com/haber
